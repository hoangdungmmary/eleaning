...
<ul class="list" data-aos="fade-down">
    <li class="btn" data-src="image/bg6.png">breakfast</li>
    <li class="btn active" data-src="image/bg4.png">lunch</li>
    <li class="btn" data-src="image/bg5.png">dinner</li>
    <li class="btn" data-src="image/bg7.png">dessert</li>
</ul>

<div class="row" data-aos="fade-right">

    <div class="image" data-aos="fade-left">
        <img src="image/bg4.png" id="menu-img" alt="">
    </div>
...
<div class="box-container">
    ...
    <div class="box" data-aos="fade-left">
        ...
        <a href="py.php"><button class="btn">Xem thêm</button></a>
    </div>
...
<div class="box-container">
    ...
    <div class="box" data-aos="fade-up">
        <img src="image/mon1.png" alt="">
        <h3>delicious food</h3>
    </div>

    <div class="box" data-aos="fade-up">
        <img src="image/mon2.png" alt="">
        <h3>delicious food</h3>
    </div>

    <div class="box" data-aos="fade-up">
        <img src="image/mon3.png" alt="">
        <h3>delicious food</h3>
    </div>

    <div class="box" data-aos="fade-up">
        <img src="image/mon4.png" alt="">
        <h3>delicious food</h3>
    </div>

    <div class="box" data-aos="fade-up">
        <img src="image/mon5.png" alt="">
        <h3>delicious food</h3>
    </div>

    <div class="box" data-aos="fade-up">
        <img src="image/mon6.png" alt="">
        <h3>delicious food</h3>
    </div>
